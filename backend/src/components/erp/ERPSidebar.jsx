    ...
    <div style={{
      ...
      <div style={{ padding: '16px 16px 12px', borderBottom: '1px solid rgba(255,255,255,0.10)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 9, marginBottom: 4 }}>
          <div style={{ width: 32, height: 32, background: 'rgba(255,255,255,0.15)', borderRadius: T.radius.md, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 16, flexShrink: 0 }}>🏪</div>
          <div>
            <div style={{ fontSize: 13, fontWeight: 800, color: '#fff', lineHeight: 1.2 }}>NetJetGo</div>
            <div style={{ fontSize: 9, color: T.text.onBrandMuted, letterSpacing: '0.09em', textTransform: 'uppercase' }}>ERP Platform</div>
          </div>
        </div>
        {erpUser?.shopName && (
      ...
      <nav style={{ flex: 1, padding: '8px 8px', overflowY: 'auto' }}>
        {Object.entries(grouped).map(([section, items]) => (
          <div key={section} style={{ marginBottom: 4 }}>
            <p style={{ color: T.text.onBrandMuted, fontSize: 9, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.09em', padding: '6px 10px 3px', marginTop: 6 }}>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    cursor: 'pointer', borderRadius: T.radius.md, marginBottom: 1, textAlign: 'left',
